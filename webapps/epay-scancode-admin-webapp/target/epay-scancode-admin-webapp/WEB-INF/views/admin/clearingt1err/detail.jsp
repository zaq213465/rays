...
<table class="table table-striped table-bordered" id="sample_6">
	...
	<tr>
		...
		<td class="col-md-2 td0">订单金额(元)</td><td class="col-md-4 parent_id_parse" ><fmt:formatNumber value="${item.orderAmt}" pattern="#0.00"/></td>
	</tr>
	<tr>
	...
	<tr>
		<td class="col-md-2 td0">支付额度(元)</td><td class="col-md-4 parent_id_parse" ><fmt:formatNumber value="${item.totalAmount}" pattern="#0.00"/></td>
		<td class="col-md-2 td0">用户支付的款(元)</td><td class="col-md-4 parent_id_parse" ><fmt:formatNumber value="${item.buyerPayAmount}" pattern="#0.00"/></td>
	</tr>
	<tr>
		<td class="col-md-2 td0">积分优惠(元)</td><td class="col-md-4 parent_id_parse" ><fmt:formatNumber value="${item.pointAmount}" pattern="#0.00"/></td>
