...
<div class="page-footer">
	<div class="page-footer-inner">
		 2017 &copy; ${currentChannelInfo.companyName } 版权所有 ${currentChannelInfo.recordNumber }
	</div>
...
// 	});
	...
	$(".headerUl .headerLi2").hover(function(){
			...
			success : {
				...
				callback : function() {
					...
					if (flag == 0) {
						...
						$.ajax({
								type : "POST",
								 url : "sys/admin/reset/"+ '${currentScanAdminUser.id}'+"/"+'${currentScanAdminUser.userName}',
