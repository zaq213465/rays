...
<head>
<meta charset="utf-8"/>
<title>PlatfromAuditLog Edit</title>
						...
						<div class="form-body">
							<input type="hidden" id="id"  name = "id" value="${id}">
									<div class="row">
										<div class="col-md-8">
											<div class="form-group">
												<label class="control-label col-md-2"><span style="color: red">*</span>审核意见</label>
												<div class="col-md-5">
									...
									<div class="row">
										<div class="col-md-8">
											<div class="form-group">
												<label class="control-label col-md-2"><span style="color: red">*</span>审核状态</label>
												<div class="col-md-5">
