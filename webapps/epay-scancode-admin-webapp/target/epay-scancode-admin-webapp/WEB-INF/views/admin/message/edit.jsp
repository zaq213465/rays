						...
						<div class="form-body">
							<input type="hidden" id="id"  name = "id" value="${Obj.id}">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label class="control-label col-md-2"><span style="color: red">*</span>用户类型</label>
												<div class="col-md-4">
													<c:if test="${Obj == null}">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label class="control-label col-md-2"><span style="color: red">*</span>标题</label>
												<div class="col-md-4">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label class="control-label col-md-2"><span style="color: red">*</span>类型</label>
												<div class="col-md-4">
													<c:if test="${Obj == null}">
