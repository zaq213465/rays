							...
							<div class="row">
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<div class="col-md-8">
											<select id="agentNo" name="agentNo" class="form-control" >
												<option value='' val = "">  --  请选择  --  </option>
												<c:forEach items="${agents}" var="obj">
													<option value='${obj.agentNo}' val = "${obj.channelNo}">${obj.agentName}</option>												
												</c:forEach>
									        </select>
<!-- 												<input type="text" class="form-control" id="agentName" name="agentName"> -->
							...
							<div class="row">
								<div class="col-md-3">
									<div class="form-group" >
										<label class="control-label col-md-4">商户模式</label>
										<div class="col-md-8">
											<select id = "registerType" class="form-control" name="registerType">
												<option value = "">  --  请选择  --  </option>
												<option value = "1">大商户模式</option>
												<option value = "2">一户一码模式</option>
											</select>
										</div>
									</div>
								</div>
