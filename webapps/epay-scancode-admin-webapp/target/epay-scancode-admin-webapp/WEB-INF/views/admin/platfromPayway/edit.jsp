					...
					<form class="form-horizontal" id="form">
							...
							<div class="form-body">
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<label class="control-label col-md-2"><span style="color: red">*</span>支付通道</label>
											<div class="col-md-4">
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<label class="control-label col-md-2"><span style="color: red">*</span>通道类型</label>
											<div class="col-md-4">
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<label class="control-label col-md-2"><span style="color: red">*</span>支付通道描述</label>
											<div class="col-md-4">
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<div class="col-md-4">
												<input type="text" class="form-control ajaxCheck"
													id="rate" name="rate" value="<fmt:formatNumber value="${Obj.rate}" pattern="#0.00"/>"
...
<script src="${path}/resources/scripts/admin/platfromPayway/edit.js?rnd=${version}" type="text/javascript"></script>
