...
<table class="table table-striped table-bordered" id="sample_6">
	...
	<tr>
		<td class="col-md-2 td0">通道编号</td><td class="col-md-4 parent_id_parse" title="passageNo">${item.passageNo}</td>
	</tr>
	<tr>
		<td class="col-md-2 td0">接口类型</td><td class="col-md-4 parent_id_parse" title="tradeType">${item.tradeType}</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="col-md-2 td0">交易状态</td><td class="col-md-4 parent_id_parse" title="tradeStatus">${item.tradeStatus}</td>
	</tr>
	
	<tr>
		<td class="col-md-2 td0">回调状态</td><td class="col-md-4 parent_id_parse" title="notifyStatus">${item.notifyStatus}</td>
	</tr>
