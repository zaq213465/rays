					...
					<form action="save" class="form-horizontal" id="form" method="post">
						<div class="form-body">
									...
									<div class="form-group">
										<label class="control-label col-md-2"><span style="color: red">*</span>账号</label>
											...
											<div class="col-md-4" style="margin-top: 7px;">
												${Obj.merchantNo}
												<input type="hidden" class="form-control" name = "merchantNo" value="${Obj.merchantNo}">
											</div>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<label class="control-label col-md-2"><span style="color: red">*</span>昵称</label>
										<div class="col-md-4">
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<label class="control-label col-md-2"><span style="color: red">*</span>手机</label>
											<div class="col-md-4">
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<label class="control-label col-md-2"><span style="color: red">*</span>余额</label>
											<div class="col-md-4">
												<input type="text" class="form-control" id="balance" name="balance" value="${Obj.balance }">
											</div>
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<div class="col-md-4">
												<input type="text" class="form-control" id="status" name="status" value="${Obj.status }">
											</div>
										</div>
									</div>
								</div>
								...
								<div class="col-md-12">
									...
									<div class="form-group">
										...
										<div class="col-md-10">
											...
											<button type="button" class="btn default" id="cancle" onclick="cancel();">取消</button>
										</div>
									</div>
								</div>
							</div>
...
<%-- <script src="${path}/resources/scripts/admin/consumeraccounts/edit.js?rnd=${version}" type="text/javascript"></script> --%>
