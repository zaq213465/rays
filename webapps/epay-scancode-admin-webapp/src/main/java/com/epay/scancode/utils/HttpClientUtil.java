package com.epay.scancode.utils;
...
public class HttpClientUtil {
	...
	public static String sendHttpMessage(String url,Map<String, String> map) throws ClientException, NoHttpResponseException{
		String falses = "falses";
		try {
