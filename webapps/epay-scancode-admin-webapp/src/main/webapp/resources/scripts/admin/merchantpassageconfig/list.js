$(function(){
	...
	$("#query").click(function(){
		...
		$.ajax({
			   type: "POST",
			   url: "merchantpassageconfig/content",
			   data:datajson,
...
//  		$.ajax({
// 		   type: "POST",
// 		   url: "merchantpassageconfig/updateStatus",
...
function toPage(pageNumber){
	...
	$.ajax({
		   type: "POST",
		   url: "merchantpassageconfig/content?pageNo="+pageNumber,
		   data:datajson,
		   success: function(msg){
			   $("#tablec").html(msg);
		   },
