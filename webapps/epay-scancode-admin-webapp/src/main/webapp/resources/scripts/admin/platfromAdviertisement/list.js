$(function(){
	...
	$("#query").click(function(){
		...
		$.ajax({
			   type: "POST",
			   url: "platfromAdviertisement/content",
			   data:datajson,
...
function updateStatus(btn){
    ...
    bootbox.confirm("确定执行该操作吗?", function(result) {
  	  if(result){
  		$.ajax({
 		   type: "POST",
 		   url: "platfromAdviertisement/updateStatus",
...
function del(obj){
    ...
    bootbox.confirm("确定执行该操作吗?", function(result) {
  	  if(result){
  		$.ajax({
 		   type: "POST",
 		   url: "platfromAdviertisement/del",
 		   data:{"id":obj},
 		   success: function(msg){
...
function toPage(pageNumber){
	$.ajax({
		   type: "POST",
		   url: "platfromAdviertisement/content?pageNo="+pageNumber,
		   success: function(msg){
			     $("#tablec").html(msg);
		   }
		});
