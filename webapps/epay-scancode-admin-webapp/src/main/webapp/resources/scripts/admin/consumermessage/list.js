...
function toPage(pageNumber){
	...
	console.info(merchantNoCheck+"123");
	$.ajax({
		   type: "POST",
		   url: "consumermessage/content?pageNo="+pageNumber + "&merchantNoCheck=" + merchantNoCheck,
		   data:datajson,
...
function updateStatus(btn){
    ...
    bootbox.confirm("确定执行该操作吗?", function(result) {
  	  if(result){
  		$.ajax({
 		   type: "POST",
 		   url: "consumermessage/updateStatus",
