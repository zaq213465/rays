...
<!-- 										<div class="col-md-8"> -->
<!-- 											<input type="text" class="form-control date-picker" name="createTime" id="createTime"> -->
<!-- 										</div> -->
<!-- 									</div> -->
<!-- 								</div> -->
<!-- 								/span -->
						...
						<div class = "row">
							<div class="col-md-3">
									<div class="form-group">
										...
										<div class="col-md-8">
											<input type="text" class="form-control" id="tradeType" name="tradeType">
										</div>
									</div>
							</div>
						</div>
...
<script src="${path}/resources/scripts/admin/platfromapilog/list.js?rnd=${version}" type="text/javascript"></script>
