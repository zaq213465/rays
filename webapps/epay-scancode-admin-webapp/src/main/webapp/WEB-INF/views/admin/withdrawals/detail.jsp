...
<table class="table table-striped table-bordered" id="sample_6">
	...
	<tr>
		<td class="col-md-2 td0">提现金额(元)</td><td class="col-md-4 parent_id_parse"><fmt:formatNumber pattern="#0.00">${item.orderAmt}</fmt:formatNumber> </td>
		<td class="col-md-2 td0">提现单笔手续费(元)</td><td class="col-md-4 parent_id_parse" ><fmt:formatNumber pattern="#0.00">${item.drawFee}</fmt:formatNumber></td>
	</tr>
	<tr>
		<td class="col-md-2 td0">交易手续费(元)</td><td class="col-md-4 parent_id_parse" ><fmt:formatNumber pattern="#0.00">${item.tradeFee}</fmt:formatNumber></td>
		<td class="col-md-2 td0">商户总成本(元)</td><td class="col-md-4 parent_id_parse" ><fmt:formatNumber pattern="#0.00">${item.merchantCost}</fmt:formatNumber></td>
	</tr>
	<tr>
