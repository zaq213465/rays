					...
					<form action="save" class="form-horizontal" id="form" method="post">
						<div class="form-body">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<label class="control-label col-md-1"><span style="color: red">*</span>二级域名编号</label>
										<div class="col-md-2">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<label class="control-label col-md-1"><span style="color: red">*</span>编码抬头</label>
										<div class="col-md-2">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label col-md-2"><span style="color: red">*</span>公司简称</label>
										<div class="col-md-4">
								...
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label col-md-2"><span style="color: red">*</span>公司名称</label>
										<div class="col-md-4">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label col-md-2"><span style="color: red">*</span>电话</label>
										<div class="col-md-4">
...
<!-- 							</div> -->
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<label class="control-label col-md-1">公众号二维码</label>
										<div class="col-md-5">
...
<!-- 							</div> -->
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<label class="control-label col-md-1"><span style="color: red">*</span>关于我们</label>
										<div class="col-md-10">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<label class="control-label col-md-1"><span style="color: red">*</span>帮助中心</label>
										<div class="col-md-10">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<label class="control-label col-md-1"><span style="color: red">*</span>电子协议</label>
										<div class="col-md-10">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label col-md-2"><span style="color: red">*</span>公众号ID</label>
										<div class="col-md-4">
								...
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label col-md-2"><span style="color: red">*</span>公众号key</label>
										<div class="col-md-4">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label col-md-2"><span style="color: red">*</span>注册消息模板ID</label>
										<div class="col-md-4">
								...
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label col-md-2"><span style="color: red">*</span>支付消息模板ID</label>
										<div class="col-md-4">
											<input type="text" class="form-control"
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label col-md-2"><span style="color: red">*</span>提现模版ID</label>
										<div class="col-md-4">
											<input type="text" class="form-control" 
...
<!-- 							"agencyId":"1075888890", -->
<!-- 							"wxNotifyUrl":"https://bbwap.webankbill.com/webank/callback/wx", -->
<!-- 							"appid":"wxf57c06b9d99b4243" -->
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label col-md-2"><span style="color: red">*</span>微信大商户代理商号</label>
										<div class="col-md-4">
											<input type="text" class="form-control" 
												id="wxAgencyId1" name="wxAgencyId1" value="${channelPayParams.wxagencyId1}"
												placeholder="微信大商户代理商号">
										</div>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label col-md-2"><span style="color: red">*</span>微信一户一码代理商号</label>
										<div class="col-md-4">
											<input type="text" class="form-control"
												id="wxAgencyId2" name="wxAgencyId2" value="${channelPayParams.wxagencyId2}"
												placeholder="微信一户一码代理商号">
										</div>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label col-md-2"><span style="color: red">*</span>支付宝大商户代理商号</label>
										<div class="col-md-4">
											<input type="text" class="form-control" 
												id="zfbAgencyId1" name="zfbAgencyId1" value="${channelPayParams.zfbagencyId1}"
												placeholder="支付宝大商户代理商号">
										</div>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label col-md-2"><span style="color: red">*</span>支付宝一户一码代理商号</label>
										<div class="col-md-4">
											<input type="text" class="form-control" 
												id="zfbAgencyId2" name="zfbAgencyId2" value="${channelPayParams.zfbagencyId2}"
												placeholder="支付宝一户一码代理商号">
										</div>
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label col-md-2"><span style="color: red">*</span>银行卡号码</label>
										<div class="col-md-4">
											<input type="text" class="form-control"
								...
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label col-md-2"><span style="color: red">*</span>联行号</label>
										<div class="col-md-4">
							...
							<div class="row">								
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label col-md-2"><span style="color: red">*</span>开户行名称</label>
										<div class="col-md-4">
											<input type="text" class="form-control" readonly="readonly"
								...
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label col-md-2"><span style="color: red">*</span>账户类型
										</label>
										<div class="col-md-4">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label col-md-2"><span style="color: red">*</span>身份证号码</label>
										<div class="col-md-4">
											<input type="text" class="form-control"
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label col-md-2"><span style="color: red">*</span>手机号码</label>
										<div class="col-md-4">
											<input type="text" class="form-control"
