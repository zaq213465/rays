...
<table class="table table-striped table-bordered" id="sample_6">
	...
	<tr>
		...
		<td class="col-md-2 td0">订单金额(元)</td><td class="col-md-4 parent_id_parse" > <fmt:formatNumber pattern="#0.00">${item.orderAmt}</fmt:formatNumber> </td>
	</tr>
	<tr>
		<td class="col-md-2 td0">订单原交易金额(元)</td><td class="col-md-4 parent_id_parse"><fmt:formatNumber pattern="#0.00">${item.tradeAmt}</fmt:formatNumber></td>
		<td class="col-md-2 td0">打折金额(元)</td><td class="col-md-4 parent_id_parse" ><fmt:formatNumber pattern="#0.00">${item.discountAmt}</fmt:formatNumber></td>
	</tr>
	<tr>
		<td class="col-md-2 td0">打折策略</td><td >
		${item.discountStrategy}
		</td>
		<td class="col-md-2 td0">门店</td><td >
		${item.storeName}
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="col-md-2 td0">支付额度(元)</td><td class="col-md-4 parent_id_parse" ><fmt:formatNumber pattern="#0.00">${item.totalAmount}</fmt:formatNumber></td>
		<td class="col-md-2 td0">用户支付的款(元)</td><td class="col-md-4 parent_id_parse" ><fmt:formatNumber pattern="#0.00">${item.buyerPayAmount}</fmt:formatNumber></td>
	</tr>
	<tr>
		<td class="col-md-2 td0">积分优惠(元)</td><td class="col-md-4 parent_id_parse" ><fmt:formatNumber pattern="#0.00">${item.pointAmount}</fmt:formatNumber></td>
	...
	<tr>
		<td class="col-md-2 td0">支付方式</td><td >
...
<!-- 		</td> -->
	...
	<tr>
		<td class="col-md-2 td0">收银员</td><td class="col-md-4 parent_id_parse">${item.cashierName}</td>
		<td class="col-md-2 td0">操作人</td><td class="col-md-4 parent_id_parse">${item.operator}</td>
	</tr>
	<tr>
		<td class="col-md-2 td0">调账表</td><td class="col-md-4 parent_id_parse" title="taxImg">
		<c:if test="${not empty item.billing}">
		<div class="small_pic">
			<a href="#pic_taxImg">
				<img style="max-width: 150px; max-height: 150px;" src="${item.billing}">
				<div id="pic_taxImg" style="display:none;"><img style="max-width: 800px; max-height: 600px;" src="${item.billing}"></div>
			</a>
		</div>
		</c:if>
		</td>
