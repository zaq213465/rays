...
public interface ScanCodeConstants {
	 ...
	 * 调用api的接口返回审核的状态
	 */
	public static String INTERFACE_AUDIT_STATUS = "1";
	...
	public static String BUSINESSRESPONSE = "businessResponse";
	...
	public static String EXPIRETIME = "90m";
	 ...
	 * 商户入驻状态 -- 初始化
	 */
	public static String MERCHANT_JOIN_INIT = "0";
	
	/**
	 * 商户入驻状态 -- 成功
	 */
	public static String MERCHANT_JOIN_SUCCESS = "1";
	
	/**
	 * 商户入驻状态 -- 失败
	 */
	public static String MERCHANT_JOIN_FAIL = "2";
	 ...
	 * 短信前缀
	 */
	public static String SMS_PREFIX = "zf";
