...
@SelectColumnMappings({
	...
	@SelectColumnMapping(property = "passageWay", type = java.lang.String.class, table = "t_order_payment", tableAlias = "A", column = "passage_way"),
	@SelectColumnMapping(property = "ratePayCode", type = java.lang.String.class, table = "t_order_payment", tableAlias = "A", column = "rate_pay_code"),
	...
	@SelectColumnMapping(property = "billing", type = java.lang.String.class, table = "t_order_payment", tableAlias = "A", column = "billing"),
	@SelectColumnMapping(property = "tradeFrom", type = java.lang.String.class, table = "t_order_payment", tableAlias = "A", column = "trade_from"),
	@SelectColumnMapping(property = "isPrint", type = java.lang.String.class, table = "t_order_payment", tableAlias = "A", column = "is_print")
})
...
public class OrderPayment implements IdEntity<String> {
	...
	private String passageWay;//通道编号（民生、微众）商户审核时选择
	private String ratePayCode;//支付方式编号
	
	private String tradeSource;//交易来源
	private String extraTradeNo;//外部订单编号
	private String channelTradeNo;//记录支付宝，微信的订单编号
	private String billing;//调账单
	private String tradeFrom;//订单来源1.PC 2.H5
	private String isPrint;//是否已经被打印
