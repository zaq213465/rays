...
<table class="table table-striped table-bordered" id="sample_6">
	...
	<tr>
		<td class="col-md-2 td0">进出账金额(元)</td><td class="col-md-4 parent_id_parse"><fmt:formatNumber value="${item.amount}" pattern="#0.00"/></td>
	...
	<tr>
		<td class="col-md-2 td0">进出账固定成本金额(元)</td><td class="col-md-4 parent_id_parse"><fmt:formatNumber value="${item.fixedAmount}" pattern="#0.00"/></td>
		<td class="col-md-2 td0">商户总成本(元)</td><td class="col-md-4 parent_id_parse" title='payCode'><fmt:formatNumber value="${item.merchantCost}" pattern="#0.00"/></td>
	</tr>
	<tr>
