...
<table class="table table-striped table-bordered" id="sample_6">
	...
	<tr>
		<td class="col-md-2 td0">支付通道代码</td><td class="col-md-4 parent_id_parse">${item.payCode}</td>
		<td class="col-md-2 td0">支付通道名称</td><td class="col-md-4 parent_id_parse">${item.payName}</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="col-md-2 td0">提现手续费(元)</td><td colspan="3"><fmt:formatNumber value="${item.rate}" pattern="#0.00"/></td>
	</tr>
</table>
