					...
					<form action="#" class="form-horizontal" id="form">
						<div class="form-body">
							<div class="row">
								...
								<div class="col-md-3">
									<div class="form-group">
										<label class="control-label col-md-4">派币金额</label>
										<div class="col-md-8">
								...
								<div class="col-md-12">
									<div class="form-group">
										...
										<div class="col-md-10">
											...
											<%-- <button type="button" class="btn btn-default" onClick="javascript:window.location.href='${path}/consumeraccounts/0'">新增用户</a></button> --%>											
											
											<button type="button" class="btn btn-default" id="send">一键派币</a></button>
										</div>
									</div>
								</div>
								<!--/span-->
...
<script src="${path}/resources/scripts/admin/consumeraccounts/list.js?rnd=${version}" type="text/javascript"></script>
