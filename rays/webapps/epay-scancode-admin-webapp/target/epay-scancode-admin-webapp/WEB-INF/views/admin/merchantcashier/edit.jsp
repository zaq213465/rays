						...
						<div class="form-body">
							<input type="hidden" id="id"  name = "id" value="${Obj.id}">
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label class="control-label col-md-2"><span style="color: red">*</span>收银员编号</label>
												<div class="col-md-4">
													<c:if test="${Obj == null}">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label class="control-label col-md-2"><span style="color: red">*</span>门店名称</label>
												<div class="col-md-4">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label class="control-label col-md-2"><span style="color: red">*</span>身份证号</label>
												<div class="col-md-4">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label class="control-label col-md-2">微信OPENID</label>
												<div class="col-md-4">
													<input type="text" class="form-control" id="openId"  name = "openId" value="${Obj.openId}" placeholder="微信OPENID" readonly="readonly">
												</div>
											</div>
										</div>
									</div>									
