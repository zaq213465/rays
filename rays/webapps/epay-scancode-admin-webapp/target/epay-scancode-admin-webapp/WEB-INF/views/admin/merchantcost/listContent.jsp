			...
			<tr>
				<td>
					...
					<div class="data" id="bpos_money_s">
						<p>交易总金额(元)</p>
						<strong><fmt:formatNumber value="${amtStatic.orderTotalAmt}" pattern="#0.00"/></strong>
					</div>
				</td>
				<td>
					...
					<div class="data" id="bpos_money_s">
						<p>提现总金额(元)</p>
						<strong><fmt:formatNumber value="${amtStatic.txTotalAmt}" pattern="#0.00"/></strong>
					</div>
				</td>
				<td class="last">
					...
					<div class="data" id="bpos_money_s">
						<p>总成本(元)</p>
						<strong><fmt:formatNumber value="${amtStatic.totalCost}" pattern="#0.00"/></strong>
					</div>
				</td>
				<td>
					<div class="ico ico2"></div>
					<div class="data" id="bpos_money_s">
						<p>支付宝(元)</p>
						<strong><fmt:formatNumber value="${amtStatic.zfbTotalAmt}" pattern="#0.00"/></strong>
					</div>
				</td>
				<td>
					<div class="ico ico2"></div>
					<div class="data" id="bpos_money_s">
						<p>微信公众号(元)</p>
						<strong><fmt:formatNumber value="${amtStatic.wxgzhTotalAmt}" pattern="#0.00"/></strong>
					</div>
				</td>
				<td>
					<div class="ico ico2"></div>
					<div class="data" id="bpos_money_s">
						<p>微信扫码付(元)</p>
						<strong><fmt:formatNumber value="${amtStatic.wxTotalAmt}" pattern="#0.00"/></strong>
					</div>
				</td>							
			</tr>
		</tbody>
...
<table class="table table-striped table-bordered table-hover" id="sample_6">
						  ...
						  <c:forEach var="item" items="${pager.result}"> 
						   <tr>
									...
									<td><fmt:formatNumber value="${item.fixedAmount}" pattern="#0.00"/></td> --%>
									<td><fmt:formatNumber value="${item.merchantCost}" pattern="#0.00"/></td>
									<%-- <td>
