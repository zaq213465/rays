					...
					<div class="portlet box green-haze">
						...
						<div class="portlet-body" id="tablec">
						   ...
						   <tr>
								...
								<td class="parent_id_parse"><fmt:formatNumber value="${item.rate}" pattern="#0.00"/></td>
								<td class="parent_id_parse"><fmt:formatNumber value="${item.rateAmount}" pattern="#0.00"/></td>
