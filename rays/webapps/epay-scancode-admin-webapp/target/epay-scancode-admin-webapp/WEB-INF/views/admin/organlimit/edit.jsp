					...
					<form action="save" class="form-horizontal" id="form" method="post">
						...
						<div class="form-body">
								...
								<div class="col-md-12">
									<div class="form-group">
										...
										<div class="col-md-4">
									        ...
									        <input type="hidden" class="form-control organNo" value='<c:if test="${empty Obj.organNo || Obj.organNo == '0'}">0</c:if><c:if test="${not empty Obj.organNo || Obj.organNo != '0'}">${Obj.organNo}</c:if>'>
										</div>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<label class="control-label col-md-2"><span style="color: red">*</span>限额类型</label>
										<div class="col-md-4">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<label class="control-label col-md-2"><span style="color: red">*</span>限额通道</label>
										<div class="col-md-4">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<label class="control-label col-md-2"><span style="color: red">*</span>限制方式</label>
										<div class="col-md-4">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<label class="control-label col-md-2"><span style="color: red">*</span>最低限额(元)</label>
										<div class="col-md-4">
							...
							<div class="row maxLimitDiv">
								<div class="col-md-12">
									<div class="form-group">
										<label class="control-label col-md-2"><span style="color: red">*</span>最高限额(元)</label>
										<div class="col-md-4">
