...
<table class="table table-striped table-bordered" id="sample_6">
	...
	<tr>
		<td class="col-md-2 td0">提现手续费(元)</td><td><fmt:formatNumber value="${item.rate}" pattern="#0.00"/></td>
	</tr>
	<tr>
	...
	<tr>
		<td class="col-md-2 td0">操作人</td><td title="${item.operator}">${item.operatorName}</td>
	</tr>
	<tr>
