...
<table class="table table-striped table-bordered" id="sample_6">
	...
	<tr>
		<td class="col-md-2 td0">身份证正反面</td><td class="col-md-4 parent_id_parse" title="idcardImg1">
	...
	<tr>		
		<td class="col-md-2 td0">手持身份证在店铺收银台照</td><td class="col-md-4 parent_id_parse" title="storePhotosImg">
		...
		<td class="col-md-2 td0">本人与店铺门头合照
		<c:if test="${not empty item.groupPhotoImg}">
			<br><br><a style="cursor:pointer;" class="refreshImg" attr="/${item.merchantNo}/groupPhotoImg">刷新图片</a>
		</c:if>
		</td>
		<td class="col-md-4 parent_id_parse" title="groupPhotoImg">
		<c:if test="${not empty item.groupPhotoImg}">
		<div class="small_pic">
			<a href="#pic_groupPhotoImg">
			<img style="max-width: 150px; max-height: 150px;" src="${item.groupPhotoImg}">
				<div id="pic_groupPhotoImg" style="display:none;"><img style="max-width: 800px; max-height: 600px;" src="${item.groupPhotoImg}"></div>
			</a>
		</div>
		</c:if>
		</td>
	...
	<tr>
		<td class="col-md-2 td0">操作人</td><td class="col-md-4" title="${item.operator}">${item.operatorName}</td>
