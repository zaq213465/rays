						...
						<div class="row">
									...
									<div class="col-lg-5 col-sm-6">
											<div class="form-group">
												...
												<div class="col-md-4 col-sm-4" style="margin-top: 7px;">
													<fmt:formatDate type="date" value="${item.endTime}"  pattern="yyyy-MM-dd HH:mm:ss" dateStyle="default"/>
												</div>
											</div>
								 	</div>
						  </div>
						  ...
						  <div class="col-lg-5 col-sm-6">
									<div class="form-group">
										<label class="control-label col-md-3 col-sm-4"><span style="color: red">*</span>调账表</label>
										...
										<div class="col-md-4 col-xs-4 col-sm-4" id="" style="margin-top: 7px;">
											<img id="idcardImg2_2" src="" style="max-width: 100%;"/>
											<input type="hidden" val="hidden" title="调账表图片" id="idcardImg2"  name = "idcardImg2">
										</div>
									</div>
				          </div>
						 </div>
...
<script src="${path}/resources/scripts/admin/orderrefund/edit.js?rnd=${version}" type="text/javascript"></script>
