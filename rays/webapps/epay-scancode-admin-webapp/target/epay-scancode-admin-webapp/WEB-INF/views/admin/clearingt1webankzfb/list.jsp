...
<head>
<meta charset="utf-8"/>
<title>ClearingT1WebankZfb Manager</title>
					...
					<form action="#" class="form-horizontal" id="form">
						<div class="form-body">
							...
							<div class="row">
								<div class="col-md-3">
									<div class="form-group">
										...
										<div class="col-md-8">
											<input type="text" class="form-control date-picker" id="tradeDate" name="tradeDate">
										</div>
									</div>
								</div>
								<div class="col-md-3">
									<div class="form-group">
										...
										<div class="col-md-8">
											<input type="text" class="form-control" id="agencyNo" name="agencyNo">
										</div>
									</div>
								</div>
								<div class="col-md-3">
							...
							<div class="row">
								<div class="col-md-3">
									<div class="form-group">
										<label class="control-label col-md-4">商户订单编号</label>
										<div class="col-md-8">
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<div class="col-md-8">
											<input type="text" class="form-control" id="alipayTradeNo" name="alipayTradeNo">
										</div>
									</div>
								</div>
							</div>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green-haze">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>支付宝T1对账交易流水列表
							</div>
						</div>
...
<script src="${path}/resources/scripts/admin/clearingt1webankzfb/list.js?rnd=${version}" type="text/javascript"></script>
</body>
<!-- END BODY -->
</html>