	       ...
	       <ul>
	           <li style="background:#24dde5;">
	               <div class="banDivContent">
	                   <img style="width: 100%;height: 500px;" src="${path}/resources/images/login.jpg">
	               </div>
	           </li>
	       </ul>
	   </div>
...
<div id="footer" class="clear">
    <p>Copyright ©扫码收款 2017 ${currentChannelInfo.companyName }&nbsp;&nbsp;&nbsp;&nbsp;${currentChannelInfo.recordNumber }</p>
</div>
<!-- footer end -->
<script type="text/javascript">
jQuery(document).ready(function(){
	var path = top.window.location.host;
	var menuUrl=top.window.location.href.replace(top.window.location.search,'');//替换掉多余的参数
