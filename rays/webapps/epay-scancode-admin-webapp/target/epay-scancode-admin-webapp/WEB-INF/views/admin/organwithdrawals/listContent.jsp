			...
			<tr>
				<td>
					...
					<div class="data" id="bpos_money_s">
						<p>申请提现金额(元)</p>
						<strong><fmt:formatNumber value="${amtStatic.sqtxTotalAmt}" pattern="#0.00"/></strong>
					</div>
				</td>
				<td>
					<div class="ico ico2"></div>
					<div class="data" id="bpos_money_s">
						<p>实际到账金额(元)</p>
						<strong><fmt:formatNumber value="${amtStatic.sjdzTotalAmt}" pattern="#0.00"/></strong>
					</div>
				</td>
			</tr>
		</tbody>
  ...
  <tr>
						  ...
						  <c:forEach var="item" items="${pager.result}"> 
						   <tr>
									...
									<td><fmt:formatNumber value="${item.actualAmount}" pattern="#0.00" /> </td>
									<%-- <td>${item.bankCode}</td>
									<td>${item.bankName}</td>
									<td>${item.bankCard}</td>
									<td>${item.idCard}</td>
