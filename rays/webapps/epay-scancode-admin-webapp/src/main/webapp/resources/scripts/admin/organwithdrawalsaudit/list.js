$(function(){
	...
	$("#query").click(function(){
			var $startDate = $("#queryStartDate");
			var $endDate = $("#queryEndDate");
...
//		    var end=new Date(endDate.replace("-", "/").replace("-", "/"));  
//			if(start > end){
//				$this.after("<b style = 'color : red'>结束时间小于开始时间！ </b>");
//			}
//		}
//	});
//	//给开始时间添加change事件	
//	$("#queryStartDate").change(function(){
//		var $this = $(this);
...
//		    var end=new Date(endDate.replace("-", "/").replace("-", "/"));  
//		    if(end < start){
//		    	$this.after("<b style = 'color : red'>开始时间大于结束时间！</b>");
//		        return false;  
//		    }  
