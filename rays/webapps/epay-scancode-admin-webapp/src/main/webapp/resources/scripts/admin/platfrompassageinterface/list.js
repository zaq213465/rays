$(function(){
	...
	$("#query").click(function(){
		...
		$.ajax({
			   type: "POST",
			   url: "platfrompassageinterface/content",
			   data:datajson,
...
//  		$.ajax({
// 		   type: "POST",
// 		   url: "platfrompassageinterface/updateStatus",
...
function del(obj){
    ...
    bootbox.confirm("确定执行该操作吗?", function(result) {
  	  if(result){
  		$.ajax({
 		   type: "POST",
 		   url: "platfrompassageinterface/del",
 		   data:{"id":obj},
 		   success: function(msg){
...
function toPage(pageNumber){
	...
	$.ajax({
		   type: "POST",
		   url: "platfrompassageinterface/content?pageNo="+pageNumber,
		   data:datajson,
		   success: function(msg){
			     $("#" + doEle).html(msg);
		   }
