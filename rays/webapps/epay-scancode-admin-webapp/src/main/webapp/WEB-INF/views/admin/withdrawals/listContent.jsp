			...
			<tr>
				<td>
					...
					<div class="data" id="bpos_money_s">
						<p>提现总金额(元)</p>
						<strong><fmt:formatNumber pattern="#0.00"> ${amtStatic.txTotalAmt}</fmt:formatNumber></strong>
					</div>
				</td>
				<td class="last">
					...
					<div class="data" id="bpos_money_s">
						<p>总成本(元)</p>
						<strong><fmt:formatNumber pattern="#0.00">${amtStatic.totalCost}</fmt:formatNumber> </strong>
					</div>
				</td>
				<td>
					<div class="ico ico2"></div>
					<div class="data" id="bpos_money_s">
						<p>支付宝(元)</p>
						<strong><fmt:formatNumber pattern="#0.00"> ${amtStatic.zfbTotalAmt}</fmt:formatNumber></strong>
					</div>
				</td>
				<td>
					<div class="ico ico2"></div>
					<div class="data" id="bpos_money_s">
						<p>微信公众号(元)</p>
						<strong><fmt:formatNumber pattern="#0.00"> ${amtStatic.wxgzhTotalAmt}</fmt:formatNumber></strong>
					</div>
				</td>
				<td>
					<div class="ico ico2"></div>
					<div class="data" id="bpos_money_s">
						<p>微信扫码付(元)</p>
						<strong><fmt:formatNumber pattern="#0.00"> ${amtStatic.wxTotalAmt}</fmt:formatNumber></strong>
					</div>
				</td>							
			</tr>
		</tbody>
