...
<table class="table table-striped table-bordered" id="sample_6">
	...
	<tr>
		<td class="col-md-2 td0">二维码图片</td><td class="col-md-4 parent_id_parse">
		 	<div id="qrcode">
			        <div id="codeico"><img src="${icon}" height="35px" width="35px"></div>
			 </div>
		</td>
		<td class="col-md-2 td0">二维码描述</td><td class="col-md-4 parent_id_parse" >${item.qrDesc}</td>
	</tr>
	<tr>
		<td class="col-md-2 td0">门店编号</td><td class="col-md-4 parent_id_parse" >${item.storeId}</td>
		<td class="col-md-2 td0">门店名称</td><td class="col-md-4 parent_id_parse" >${item.storeName}</td>
	</tr>
	<tr>
...
<!-- 		</td> -->
	...
	<tr>
		<td class="col-md-2 td0">操作人</td><td class="col-md-4 parent_id_parse" colspan="3" >${item.operatorName}</td>
	</tr>
</table>
