...
<table class="table table-striped table-bordered table-hover" id="sample_6">
						  ...
						  <c:forEach var="item" items="${pager.result}"> 
						   <tr>						   		
								...
								<td class="parent_id_parse" title="redAmount">${item.redAmount}</td>
								<td class="parent_id_parse" title="state">${item.state==0?"领取中":item.state==1?"领取完":"已过期"}</td>
