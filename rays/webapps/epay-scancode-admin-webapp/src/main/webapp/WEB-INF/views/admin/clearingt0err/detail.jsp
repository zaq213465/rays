...
<table class="table table-striped table-bordered" id="sample_6">
	...
	<tr>
		<td class="col-md-2 td0">提现金额(元)</td><td class="col-md-4 parent_id_parse"><fmt:formatNumber value="${item.orderAmt}" pattern="#0.00"/></td>
		<td class="col-md-2 td0">提现单笔手续费(元)</td><td class="col-md-4 parent_id_parse" ><fmt:formatNumber value="${item.drawFee}" pattern="#0.00"/></td>
	</tr>
	<tr>
		<td class="col-md-2 td0">交易手续费(元)</td><td class="col-md-4 parent_id_parse" ><fmt:formatNumber value="${item.tradeFee}" pattern="#0.00"/></td>
		<td class="col-md-2 td0">商户总成本(元)</td><td class="col-md-4 parent_id_parse" ><fmt:formatNumber value="${item.merchantCost}" pattern="#0.00"/></td>
	</tr>
	<tr>
