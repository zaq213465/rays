...
<table class="table table-striped table-bordered" id="sample_6">
	...
	<tr>
		...
		<td class="col-md-2 td0">批量批次号</td><td>${item.batchId}</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="col-md-2 td0">是否为主订单</td><td class="col-md-4 parent_id_parse">
...
<!-- 		</td> -->
	...
	<tr>
		<td class="col-md-2 td0">操作人</td><td colspan="3" class="col-md-4 parent_id_parse">${item.operator}</td>
	</tr>
</table>
