								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-10">
											...
											<button type="button" class="btn btn-default" id="newUser" onClick="javascript:window.location.href='${path}/adminManage/platfromAdviertisement/0'">新增广告</button>
										</div>
									</div>
								</div>
								<!--/span-->
...
<script src="${path}/resources/scripts/admin/platfromAdviertisement/list.js" type="text/javascript"></script>
