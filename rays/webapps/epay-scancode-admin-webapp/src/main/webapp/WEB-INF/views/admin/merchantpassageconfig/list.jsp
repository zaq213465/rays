							...
							<div class="row">
								<div class="col-md-3">
									<div class="form-group">
										...
										<div class="col-md-8">
											<input type="text" class="form-control" id="passageNo"  name="passageNo">
										</div>
									</div>
								</div>
...
<!-- 								</div> -->
							...
							<div class = "row">
								<div class="col-md-3">
									<div class="form-group">
										<label class="control-label col-md-4">通道状态</label>
										<div class="col-md-8">
											<select id="passageStatus" name="passageStatus" class="form-control">
												<option value = "">  --  请选择  --  </option>
...
<%-- 											<button type="button" class="btn btn-default" onClick="javascript:window.location.href='${path}/adminManage/merchantpassageconfig/0'">新增</a></button> --%>
										</div>
									</div>
								</div>
								<!--/span-->
...
<script src="${path}/resources/scripts/admin/merchantpassageconfig/list.js" type="text/javascript"></script>
