...
import com.epay.commons.exception.translators.SimpleErrorMessageTranslator;
...
public abstract class ExceptionHandler {
    ...
    public ExceptionHandler() {
    	innerErrorTranslator = SimpleErrorMessageTranslator.create(Locale.CHINA, "/com/epay/common/exception/exception-mapping.properties", "com.epay.common.exception.msg.error");
    }
