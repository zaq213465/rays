package com.epay.commons.base.sftp;
...
//			jsch.getSession(username, host, port);
	...
	public static void main(String[] args) {
		Sftp sf = new Sftp();
		String host = "172.16.2.203";
		int port = 22;
		String username = "zhangy";
		String password = "123456";
		String directory = "/home/zhangy/";
		
//		String downloadFile = "Result.txt";
//		String saveFile = "F:\\123.txt";
		
		//String uploadFile = "E:\\PINGANBANK-NET-B2C-GZ20140523clear.txt";
		String uploadFile = "D:\\HTF_861100014_T1_ZQ_2016-12-29.zip";
