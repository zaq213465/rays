...
@SelectColumnMappings({
	...
	@SelectColumnMapping(property = "printSwitch", type = java.lang.String.class, table = "t_print_switch", tableAlias = "A", column = "print_switch"),
})
...
public class ChannelAdmin implements IdEntity<String> {
	...
	public String getPrintSwitch() {
		return printSwitch;
	}

	public void setPrintSwitch(String printSwitch) {
