...
@SelectColumnMappings({
	...
	@SelectColumnMapping(property = "passageWay", type = java.lang.String.class, table = "t_order_pay", tableAlias = "A", column = "passage_way"),
	@SelectColumnMapping(property = "ratePayCode", type = java.lang.String.class, table = "t_order_pay", tableAlias = "A", column = "rate_pay_code"),
	...
	@SelectColumnMapping(property = "billing", type = java.lang.String.class, table = "t_order_pay", tableAlias = "A", column = "billing")
})
